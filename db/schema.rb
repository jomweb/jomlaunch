...
ActiveRecord::Schema.define(version: 20150916144244) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.string   "developer_url",   limit: 255
  ...
  add_index "projects", ["submitter_email"], name: "index_projects_on_submitter_email", using: :btree
